    ...
    return (
      <div className="review">
        ...
        { this.state.readerReviews ? this.state.readerReviews.map(review =>
          <ReviewDetails key={review.id} review={review} onEdit={this.props.onEdit} onDelete={this.props.onDelete} selectedReview={this.state.selectedReview}/>) : "You have no reviews yet!"}
